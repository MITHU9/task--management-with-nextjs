...
-- CreateTable
CREATE TABLE "public"."ProjectAccessLevel" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "ProjectAccessLevel_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectAccessLevel_workspaceMemberId_projectId_key" ON "public"."ProjectAccessLevel"("workspaceMemberId", "projectId");
...
-- AddForeignKey
ALTER TABLE "public"."ProjectAccessLevel" ADD CONSTRAINT "ProjectAccessLevel_workspaceMemberId_fkey" FOREIGN KEY ("workspaceMemberId") REFERENCES "public"."WorkspaceMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ProjectAccessLevel" ADD CONSTRAINT "ProjectAccessLevel_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "public"."Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
